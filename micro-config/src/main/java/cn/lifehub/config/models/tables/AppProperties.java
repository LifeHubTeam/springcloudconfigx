...
public class AppProperties extends BaseTable implements java.io.Serializable {
	...
	public AppProperties(Integer appId, String key, String value, Boolean deleted) {
		super();
		this.appId = appId;
		this.key = key;
		this.value = value;
	...
	public AppProperties(Integer appId, String key, String value, Boolean deleted, String describle, String modifyMan) {
		super();
		this.appId = appId;
		this.key = key;
		this.value = value;
